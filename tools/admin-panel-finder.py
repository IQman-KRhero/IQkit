...
try:
 ...
 # \_, \___/\_,_|_|   \__,_\__,_|_|_|_|_|_||_|???
  #|__/        coded by KRhero                                
 # github page : https://github.com/IQman-KRhero/IQkit
#''')
	def slowprint(s):
		for c in s + '\n' :
			sys.stdout.write(c)
...
''')
	...
	print("                                                                       ")
	url = input("\033[94m →[+] IQ-KR Wants You To Enter Target Website : ")
	...
	def slowprint(f):
		for c in f + '\n' :
			...
			sys.stdout.flush()
			time.sleep(10. / 100)
	slowprint('''\033[91m [+] IQ-KR Is On Progress... Feel Free To Press Ctrl+C At Any Point To Abort... ''')
	time.sleep(2)
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html','panel.php/',)
	for hani in passe :
		curl = url+hani
		try :
...
try:
	...
	time.sleep(2)
	os.system('clear')
	slowprint("\n\033[91m [#] Respect me :> KRhero - IQman  \n")
	time.sleep(2)
	os.system('clear')
except KeyboardInterrupt:
